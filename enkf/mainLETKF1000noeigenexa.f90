program letkf1000
   ...
   !hscaleqv = 1000.d0*hscaleqv/resolution
   ...
   !do j = 1+djs, 1+djs
	 ...
	 !print*, i, j, mobs, mmax
	 if (mobs == 0) cycle
	 !print*, mobs, minval(Y0(1:mobs)), maxval(Y0(1:mobs)), minval(Y(1:mobs,:)), maxval(Y(1:mobs,:))
	 !
	 !
	 !
	 ! Eigen-decomposition
	 ...
	 !print*, i, j, mobs, nrank, gammab(1), lambda(1), d(1)
