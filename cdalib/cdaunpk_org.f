     ...
     \                  NXHT,NXEL,NXIH,NXIE,NXQC,NXPF2)
      ...
      ELSE IF (IC1(14).EQ.4) THEN
        ...
        do i = 1, len4
           ...
           call movec(jw4(i), 1, iw4(2*i-1), 1, 4)
           call movec(rw4(i), 1, iw4(2*i-1), 1, 4) !TAB replaced by 8 spaces K. Ito 2012/09/09
        end do  !TAB replaced by 8 spaces  K. Ito 2012/09/09
