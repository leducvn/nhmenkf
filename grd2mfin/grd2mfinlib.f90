...
contains
   ...
   !
   !
   subroutine write_hydro_ic(fileout, idate, vctrans_type, n_vctrans, ix1, ix2, iy1, iy2, iz1, iz2, &
                           & pseam, ptopm, pgrdm, dtratio, zl_vctrans, zh_vctrans, dx, dxl, dxr, dy, dyl, dyr, dz, dzl, dzr, &
		           & ptgrd, ptgrdt, sst, psurf, tin, u, v, pt, qv, nx, ny, nz)
      implicit none
      !
      ...
      real, dimension(nx,ny,nz), intent(in) :: u, v, pt, qv
      ...
      write(fileout) pt
      write(fileout) qv
      write(fileout) ptgrd,ptgrdt,sst,psurf,tin
      close(fileout)
      !
      return
   end subroutine write_hydro_ic
   !
   !
   !
   subroutine write_nonhydro_ic(fileout, idate, vctrans_type, n_vctrans, ix1, ix2, iy1, iy2, iz1, iz2, &
                     & pseam, ptopm, pgrdm, dtratio, zl_vctrans, zh_vctrans, dx, dxl, dxr, dy, dyl, dyr, dz, dzl, dzr, &
      ...
      !
      return
   end subroutine write_nonhydro_ic
   !
   !
   !
end module grd2mfinlib