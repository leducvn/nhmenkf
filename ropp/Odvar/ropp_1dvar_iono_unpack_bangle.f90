! $Id: ropp_1dvar_iono_unpack_bangle.f90 4010 2014-01-10 11:07:40Z idculv $

!****s* Ionosphere/ropp_1dvar_iono_unpack_bangle *
!
! NAME
!    ropp_1dvar_iono_unpack_bangle - Unpack (bangle_L1, bangle_L2) etc into 
!                                    {bangle_n, bangle_L1, bangle_L2} etc
!
! SYNOPSIS
!    CALL ropp_1dvar_iono_unpack_bangle(res_data)
!
! DESCRIPTION
...
!    and bangle_L2.  Similarly for impact parameters.
!
! INPUTS
...
! --------------------
  ...
  CALL message_set_routine('ropp_1dvar_iono_unpack_bangle')
