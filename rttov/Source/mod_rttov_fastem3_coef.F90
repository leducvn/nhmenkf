...
MODULE mod_rttov_fastem3_coef
  ...
  ! Description:
  ! Constant coefficients and parameters for FASTEM-3.
  !
  ! Copyright:
  ...
  !
  ! Method:
  ! The FASTEM-3 coefficients have been moved here from the 
  ! instrument coefficient files.
  !
  ...
  ! -------   ----     -------
  !  1.0      19/10/2010   New F90 code (J Hocking)
  !
  ! Code Description:
  !   Language:           Fortran 90.
