...
!  1.5       31/01/2007  Removed polarisation (R Saunders)
!  1.6       14/03/2007  Added abs to windratio (earlier bugfix   never implemented) RS
!  1.7       08/10/2008  Fixed adjoint/k bug for v < 0.0001; tidied (A Geer)
!
