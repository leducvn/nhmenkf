module variable
   ...
   !
   real, dimension(:), allocatable :: vdz, vrdz, vrdz2, zrp, zrw, vctrans_p, vctrans_w, dvtrans_p, dvtrans_w
   real, dimension(:,:), allocatable :: zs, landsea, lon, lat
   real, dimension(:,:,:), allocatable :: fmap
   real, dimension(:,:), allocatable :: ps, pb, pts, dps
   real, dimension(:,:,:), allocatable :: tsoil, dtsoil
   real, dimension(:,:,:), allocatable :: u, v, w, dua, dva, dwa, du, dv, dw
   real, dimension(:,:,:), allocatable :: h, t, pt, dt
   real, dimension(:,:,:), allocatable :: p, pnh, dpnh
   real, dimension(:,:,:), allocatable :: qv, rh, qc, dqv, dqc
   real, dimension(:,:,:), allocatable :: qi, qr, qs, qg, dqi, dqr, dqs, dqg
   real, dimension(:,:), allocatable :: sst, ptop, pmsl, dptsdt
   !
   namelist /control/ iyear, imonth, iday, ihour, iminute
